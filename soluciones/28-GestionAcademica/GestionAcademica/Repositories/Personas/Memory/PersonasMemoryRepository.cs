...
public class PersonasMemoryRepository : IPersonasRepository {
    private static readonly Lazy<PersonasMemoryRepository> Lazy = new(() => new PersonasMemoryRepository());
    ...
    private PersonasMemoryRepository() { }

    public static PersonasMemoryRepository Instance => Lazy.Value;
